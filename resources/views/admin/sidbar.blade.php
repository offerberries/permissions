<nav id="sidebar" class="active">
            ...
            <ul class="list-unstyled components text-secondary">
                ...
                <li>
                    <a href="{{url('roles')}}"><i class="fas fa-user-friends"></i>Users</a>
                </li>
                <li>
                    <a href="{{ route('role.create') }}"><i class="fas fa-user-friends"></i>Create Roles</a>
                </li>
                <li>
                    <a href="{{ route('permission.create') }}"><i class="fas fa-user-friends"></i>Create Permissions</a>
                </li>
                <li>
                    <a href="{{ route('assign-permissions-to-role.create') }}"><i class="fas fa-user-friends"></i>Assign Permission To Roles</a>
                </li>
                <li>
